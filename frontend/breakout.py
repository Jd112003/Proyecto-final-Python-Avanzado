...
class Game:
    def __init__(self):
        ...
        # Usar Font(None, ...) para compatibilidad web (SysFont no existe en navegador)
    ...
    def draw(self):
        s = self.screen.window # Dibujar directo en la ventana
        ...
        # Dibujar texto de Game Over / Win siempre al final
        if self.round_over_text:
